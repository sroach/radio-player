...
class Station {
    val array = listOf(
        ...
        StationItem(index = 13, url = "https://icecast.walmradio.com:8443/classic", label = "Classic", type = "big band,classic hits"),
        StationItem(index = 14, url = "https://cast4.asurahosting.com/proxy/ncn1001/stream", label = "Vybz 100.1 FM live", type = "Reggae, Oldies"),
        StationItem(index = 15, url = "http://185.80.220.12:8046/stream?cb=307101.mp3", label = "Bollywood Radio & Beyond", type = "Bollywood"),
        StationItem(index = 16, url = "http://www.desizone.nl:8000/listen.pls?sid=1&t=.pls", label = "Desi Zone", type = "Bollywood"),
        StationItem(index = 17, url = "http://109.169.46.197:8011/listen.pls?sid=1&t=.pls", label = "Diverse FM", type = "Bollywood"),
        ...
        StationItem(index = 19, url = "https://eu8.fastcast4u.com/proxy/clyedupq?mp=/1&DIST=TuneIn&TGT=TuneIn&maxServers=2&gdpr=0&us_privacy=1YNY&partnertok=eyJhbGciOiJIUzI1NiIsImtpZCI6InR1bmVpbiIsInR5cCI6IkpXVCJ9.eyJ0cnVzdGVkX3BhcnRuZXIiOnRydWUsImlhdCI6MTY0MjM1NzI1NiwiaXNzIjoidGlzcnYifQ.EAssq2ZkcXQlSiawuzVsWrII1AJAgt_pXy03dWMFBKw", label = "Hindi Desi Bollywood", type = "Bollywood"),
        StationItem(index = 20, url = "http://auds1.intacs.com/ntnradio", label = "NTN Radio 89.1 Georgetown", type = "bollywood,georgetown,south asian music")
    )
